...
## Automatisch posten — wat kan wél/niet

- **Feed-posts & Reels:** kunnen automatisch posten (zakelijk IG-account gekoppeld aan
  een Facebook-pagina vereist).
- **Stories:** kunnen automatisch, maar schakelen naar een *herinnering* (melding →
  zelf tikken) zodra er muziek, stickers, een poll of link in zit — dus in de praktijk
  vaak handmatig.
- **Google Bedrijfsprofiel:** zit niet in Buffer → handmatig, 1x/week.
